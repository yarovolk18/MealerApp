...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnRegClient;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_reg_client;
      Button btnRegClient = ViewBindings.findChildViewById(rootView, id);
      if (btnRegClient == null) {
        break missingId;
      }

      id = R.id.btn_reg_cook;
      Button btnRegCook = ViewBindings.findChildViewById(rootView, id);
      if (btnRegCook == null) {
        break missingId;
      }
